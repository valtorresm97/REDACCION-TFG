...
\begin{figure}[H]
    ...
    \begin{tikzpicture}[
        ...
        procblock/.style={draw, rounded corners, align=center, minimum width=3.2cm, minimum height=0.85cm, font=\small},
        ...
        \node[procblock, below=1.0cm of mcu] (pack) {TxBlockRing\\agrupa 8 muestras};
        ...
        \node[procblock, below=1.0cm of rx] (validate) {validación de contrato\\longitud, índices, status};
        \node[procblock, below=1.0cm of backend] (drain) {drenado periódico\\hacia procesador EEG};

        \node[procblock, below=1.05cm of validate] (queue) {cola RX\\bloques válidos};
        \node[procblock, below=1.05cm of drain] (procnode) {EEGSignalProcessor\\buffer multicanal};
        \node[procblock, below=1.05cm of queue, fill=gray!5] (capture) {CaptureManager\\ruta lateral};
        ...
        \node[font=\scriptsize, align=center, below=0.25cm of procnode] {Salida del bloque:\\muestras listas para DSP};
    \end{tikzpicture}}
