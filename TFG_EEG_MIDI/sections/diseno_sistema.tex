...
\begin{figure}[H]
    ...
    \begin{tikzpicture}[
        ...
        \node[note, below=0.15cm of montaje] {CH1 es el canal EEG principal\\en la configuración final};
        \node[note, below=0.15cm of escala] {CH2--CH4 se conservan\\por contrato de datos};
    \end{tikzpicture}}
