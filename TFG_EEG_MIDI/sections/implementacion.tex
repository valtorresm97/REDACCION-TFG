...
\begin{table}[H]
    ...
    \begin{tabular}{p{0.30\textwidth}p{0.22\textwidth}p{0.38\textwidth}}
        ...
        Bloque de entrada & 8 muestras, \SI{32}{\milli\second} & Unidad mínima recibida mediante \texttt{eeg\_block\_uV}. \\
        Ventana de análisis & \SI{4}{\second}, 1000 muestras & Tramo de señal usado para calcular características espectrales. \\
        Hop de features & 64 muestras, \SI{256}{\milli\second} & Cadencia nominal de actualización de características EEG, aproximadamente \SI{3.9}{\hertz}. \\
        Snapshot & \SI{0.2}{\second}, \SI{5}{\hertz} & Publicación de la vista pública del estado; no marca la cadencia de generación musical. \\
        \hline
    \end{tabular}
\end{table}

Por tanto, el backend maneja varias cadencias simultáneas. Los bloques EEG llegan cada \SI{32}{\milli\second}; las características espectrales se recalculan aproximadamente cada \SI{256}{\milli\second}; y el \textit{snapshot} se reconstruye cada \SI{0.2}{\second} para WebUI, capturas y validación. Esta última frecuencia no significa que se genere música nueva a \SI{5}{\hertz}; la generación musical sigue una cadencia propia, asociada a la duración del compás musical.
