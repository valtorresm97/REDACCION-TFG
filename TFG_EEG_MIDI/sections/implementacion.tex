...
\IfFileExists{images/uml/impl_backend_flujo_python.png}{%
    \includegraphics[width=1\textwidth]{images/uml/impl_backend_flujo_python.png}
}{%
...
\IfFileExists{images/uml/impl_backend_buffer_ventana.png}{%
    \includegraphics[width=0.45\textwidth]{images/uml/impl_backend_buffer_ventana.png}
}{%
