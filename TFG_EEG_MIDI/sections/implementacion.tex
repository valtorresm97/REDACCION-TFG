...
\texttt{EEGSignalProcessor} transforma la sucesión de bloques recibidos en una señal temporal continua. Cada bloque llega en microvoltios con forma lógica \texttt{(n\_samples, num\_channels)}. Antes de escribir las muestras en memoria, el backend las convierte a voltios:
