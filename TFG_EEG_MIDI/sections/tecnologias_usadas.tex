...
A lo largo de este trabajo se han empleado distintas tecnologías hardware y software para el desarrollo del sistema propuesto. El proyecto integra adquisición de señales EEG, procesado digital, generación musical, comunicación  a trvés del protocolo MIDI, visualización de datos y diseño electrónico. A continuación, se describen las principales tecnologías utilizadas.
