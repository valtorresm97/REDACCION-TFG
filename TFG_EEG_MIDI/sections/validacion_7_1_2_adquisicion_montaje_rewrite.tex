...
Una vez comprobada la ruta de adquisición, se compararon diferentes configuraciones físicas de electrodos y modos de operación del ADS1299. Para esta validación se utilizaron ocho capturas específicas, agrupadas en dos montajes: \texttt{ear\_eeg\_ch1\_only} y \texttt{fp1\_fp2\_ch1\_only}. Las capturas empleadas se resumen en la Tabla~\ref{tab:validacion_capturas_montaje}.
...
\begin{table}[H]
    ...
    \begin{tabular}{p{0.26\textwidth} p{0.28\textwidth} p{0.34\textwidth}}
        \hline
        \textbf{Montaje} & \textbf{Condición} & \textbf{Captura} \\
        \hline
        Ear-EEG CH1 & Reposo quieto & \texttt{20260523-195752\_ear\_eeg\_ch1\_only\_still\_30s} \\
        Ear-EEG CH1 & Ojos abiertos & \texttt{20260523-200925\_ear\_eeg\_ch1\_only\_eyes\_open\_60s} \\
        Ear-EEG CH1 & Ojos cerrados & \texttt{20260523-201055\_ear\_eeg\_ch1\_only\_eyes\_closed\_60s} \\
        Ear-EEG CH1 & Mandíbula & \texttt{20260523-201321\_ear\_eeg\_ch1\_only\_jaw\_movement\_30s} \\
        Fp1--Fp2 CH1 & Reposo quieto & \texttt{20260523-202120\_fp1\_fp2\_ch1\_only\_quiet\_30s} \\
        Fp1--Fp2 CH1 & Ojos abiertos & \texttt{20260523-202208\_fp1\_fp2\_ch1\_only\_eyes\_open\_60s} \\
        Fp1--Fp2 CH1 & Ojos cerrados & \texttt{20260523-202323\_fp1\_fp2\_ch1\_only\_eyes\_closed\_60s} \\
        Fp1--Fp2 CH1 & Parpadeo/frente & \texttt{20260523-202451\_fp1\_fp2\_ch1\_only\_forehead\_blink\_artifact\_30s} \\
        \hline
    \end{tabular}
\end{table}

La primera lectura de estas capturas se realizó en el dominio temporal. El objetivo fue comprobar que las señales quedaban registradas de forma continua en todas las condiciones y que las diferencias observadas procedían del montaje o del estado experimental, no de fallos de transporte. La Figura~\ref{fig:validacion_montaje_temporales_grid} resume las señales temporales de las ocho capturas usadas para comparar montajes.

\begin{figure}[H]
    \centering
    \validacioninclude{width=0.98\textwidth}{images/validacion/fig_02_mounting_timeseries_grid.png}
    \caption{Comparación temporal de las capturas empleadas para validar el montaje experimental. La figura agrupa las condiciones realizadas con montaje \texttt{ear\_eeg\_ch1\_only} y con montaje \texttt{fp1\_fp2\_ch1\_only}, permitiendo comprobar la continuidad de adquisición y la presencia de diferencias asociadas al montaje, a la condición experimental y a los artefactos.}
    \label{fig:validacion_montaje_temporales_grid}
\end{figure}
...
\begin{figure}[H]
    ...
    \begin{minipage}{0.90\textwidth}
        \centering
        \small (a) RMS mediano
        \validacioninclude{width=0.90\textwidth}{images/validacion/fig_02_mounting_rms_comparison.png}
    \end{minipage}
    ...
    \begin{minipage}{0.90\textwidth}
        ...
        \validacioninclude{width=0.90\textwidth}{images/validacion/fig_02_mounting_ptp_comparison.png}
    \end{minipage}
...
\begin{figure}[H]
    ...
    \begin{minipage}{0.90\textwidth}
        \centering
        \small (a) Componente relativa de 50 Hz
        \validacioninclude{width=0.90\textwidth}{images/validacion/fig_02_mounting_50hz_comparison.png}
    \end{minipage}
    ...
    \begin{minipage}{0.90\textwidth}
        ...
        \validacioninclude{width=0.90\textwidth}{images/validacion/fig_02_mounting_artifact_fraction.png}
    \end{minipage}
