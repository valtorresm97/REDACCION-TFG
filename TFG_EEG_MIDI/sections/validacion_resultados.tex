...
\begin{figure}[htbp]
    ...
    \end{minipage}
    \caption{Comparación temporal de estados con mayor presencia de artefactos. Los tramos de mandíbula y parpadeo/frente introducen cambios de amplitud y morfología que justifican no tratar todas las ventanas como señal EEG útil.}
    \label{fig:validacion_estados_temporales_artefactos}
\end{figure}

Las Figuras~\ref{fig:validacion_estados_temporales_reposo} y~\ref{fig:validacion_estados_temporales_artefactos} muestran que los estados de reposo y recuperación presentan una dinámica más contenida, mientras que los estados asociados a mandíbula o parpadeo/frente introducen cambios de mayor amplitud y morfología distinta. Estos tramos son útiles para validar que el sistema no debe interpretar todos los cambios de la señal como variaciones EEG útiles para la sonificación.
